...
4. **Branch.** `git checkout -b feat/<feature-slug>` — one Feature, one branch, one PR.
5. **Print the plan** — the Feature id + its US ids in build order — and STOP. No code at this stage.
